...
import { PHONE_RAW, EMAIL, WHATSAPP_URL, API_CONTACT_ENDPOINT } from '../constants';
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus({
        type: 'success',
        text: 'Thank you! Your inquiry has been sent to our team.'
      });
      setFormData({
        name: '',
        phone: '',
      ...
      setStatus({
        type: 'error',
        text: 'Failed to send inquiry. Please try again or contact us via WhatsApp.'
      });
    } finally {
      setSubmitting(false);
    }
